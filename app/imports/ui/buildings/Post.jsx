...
class Post extends React.Component {
  ...
  renderPage() {
    return (
        <Container>
          <Header as="h2" textAlign="center" inverted>Pacific Ocean Sciences and Technology Building</Header>
          <Card.Content>
...
export default withTracker(() => {
  ...
  return {
    ...
    fountains: Fountains.find({ location: 'POST', acceptance: 'accepted' }).fetch(),
  };
})(Post);
