...
class Hamilton extends React.Component {
  ...
  renderPage() {
    return (
        <Container>
          <Header as="h2" textAlign="center" inverted>Hamilton Library</Header>
          <Card.Content>
...
export default withTracker(() => {
  ...
  return {
    ...
    fountains: Fountains.find({ location: 'Hamilton', acceptance: 'accepted' }).fetch(),
  };
})(Hamilton);
