...
class Hig extends React.Component {
  ...
  renderPage() {
    ...
    return (
        <div style={menuStyle}>
          <Container>
            <Header as="h2" textAlign="center" inverted>Hawai'i Institute of Geophysics</Header>
            <Card.Group>
              <Card fluid>
                <Grid columns={2} divided style={cardStyle}>
                  <Grid.Row>
                    <Grid.Column>
                      <Image src='/fountains/hig01.jpg' />
                    </Grid.Column>
                    <Grid.Column>
              ...
              <Card fluid>
                <Grid columns={2} divided style={cardStyle}>
                  <Grid.Row>
                    <Grid.Column>
                      <Image src='/fountains/hig02.jpg' />
                    </Grid.Column>
                    <Grid.Column>
                      <Header as="h3" textAlign="left">Fountain 02</Header>
                      <Header as="h4" textAlign="left">Located: Floor 2</Header>
                      <Rating maxRating={5} clearable />
                    </Grid.Column>
                  </Grid.Row>
                </Grid>
