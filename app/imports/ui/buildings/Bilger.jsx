...
class Bilger extends React.Component {
  ...
  renderPage() {
    return (
        <Container>
          <Header as="h2" textAlign="center" inverted>Bilger Hall</Header>
          <Card.Content>
...
export default withTracker(() => {
  ...
  return {
    ...
    fountains: Fountains.find({ location: 'Bilger', acceptance: 'accepted' }).fetch(),
  };
})(Bilger);
